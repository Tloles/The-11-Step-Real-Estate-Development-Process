      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          <div className="flex items-center gap-2">
            <span className="text-[10px] uppercase tracking-widest text-gold font-semibold">Step 8</span>
            <span className="text-[10px] uppercase tracking-widest text-text-muted">Scenario</span>
          </div>
          <h2 className="text-xl font-bold text-text-primary">Completion & Opening</h2>
          <p className="text-sm text-text-secondary mt-1">CO delays, free rent periods, and opening occupancy scenarios.</p>
        </div>
      </div>
